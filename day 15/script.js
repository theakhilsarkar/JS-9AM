// array - .... of same datatype. c,cpp,java..

// const arr = [1, 2, 3, 4, 45.6];
// const fruits = ["apple", "strawberry", "mango", "banana"];

// console.log(fruits[2]);

// const arr = [1, 2, true, "apple", false, 23.45, "mango", 9825486060];

// console.log(arr[arr.length - 1]);

// object - collection of multiple values of different data types.
// we can access valye by key.
// in object values store based on keys.

// const employee = {
//   name: "rupali",
//   company: "WhiteStone Pvt",
//   phone: 9825486060,
//   isMarried: true,
//   percentage: 78.25,
// };
...
// console.log(users[0].address.geo.stars[0].name);
